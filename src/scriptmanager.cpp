...
MonsterTaskManager *g_monster_task_manager = nullptr;
...
bool ScriptingManager::loadScriptSystems() {
    ...
    g_monster_task_manager = new MonsterTaskManager();
    if (!g_monster_task_manager->loadMonsterTaskDefinitionList()) {
        std::cout << "> ERROR: Unable to load monster task definitions!" << std::endl;
        return false;
    }
