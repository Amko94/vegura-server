...
protected:
    ...
    std::map<std::string, uint8_t> spellLevels;
    time_t lastLogout;
    ...
    uint8_t getSpellLevelByName(const std::string &spellName);

    void upgradeSpellLevel(const std::string &spellName);

    void loadSpellLevels();


    void setSpellLevel(uint8_t _spellLevel) {
